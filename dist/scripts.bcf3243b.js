...
var circle = g.append('circle').attr('r', height / 2.5).attr('fill', 'yellow').attr('stroke', 'black');
var eyeSpacing = 100;
var eyeYoffset = -70;
var eyeRadius = 30;
var eyeBrowWidth = 50;
...
var eyesG = g.append('g').attr('transform', "translate(0,".concat(eyeYoffset, ")"));
var leftEye = eyesG.append('circle').attr('r', eyeRadius).attr('cx', -eyeSpacing);
var rightEye = eyesG.append('circle').attr('r', eyeRadius).attr('cx', +eyeSpacing);
var eyeBrowsG = eyesG.append('g').attr('transform', "translate(0,".concat(eyeBrowYOffset - 50, ")"));
eyeBrowsG.transition().duration(1000).attr('transform', "translate(0,".concat(eyeBrowYOffset - 50, ")")).transition().duration(1000).attr('transform', "translate(0,".concat(eyeBrowYOffset, ")"));
var leftEyebrow = eyeBrowsG.append('rect').attr('x', -eyeSpacing - eyeBrowWidth / 2).attr('width', eyeBrowWidth).attr('height', eyeBrowHeight);
var RightEyebrow = eyeBrowsG.append('rect').attr('x', +eyeSpacing - eyeBrowWidth / 2).attr('width', eyeBrowWidth).attr('height', eyeBrowHeight);
var mouth = g.append('path').attr('d', (0, _d.arc)()({
  innerRadius: 150,
  outerRadius: 170,
  startAngle: Math.PI / 2,
  endAngle: Math.PI * 3 / 2
}));
},{"d3":"../node_modules/d3/index.js"}],"../../../../../../../usr/lib/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../../../../usr/lib/node_modules/parcel/src/builtins/hmr-runtime.js","scripts/index.js"], null)
